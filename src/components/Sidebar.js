        ...
        <div className="flex flex-no-wrap">
          ...
          <div className="absolute lg:relative w-64 h-screen shadow bg-gray-100 hidden lg:block">
            <div className="h-16 w-full flex items-center px-8">
              <h3 className="text-2xl text-center mt-6 text-blue-700 font-extrabold">Placement Portal</h3>
            </div>
            <ul aria-orientation="vertical" className=" py-6">
                ...
                <div className="flex items-center">
                  <div>
                    <svg
                      ...
                      className="icon icon-tabler icon-tabler-grid text-gray-600"
                      width={20}
                      height={20}
                      viewBox="0 0 24 24"
                      strokeWidth="1.5"
                  ...
                  <Link to="/" className="ml-2 text-gray-600">Dashboard</Link>
                </div>
              </li>
              ...
              <li className="pl-6 cursor-pointer text-gray-600 text-sm leading-3 tracking-normal py-2 hover:text-indigo-700 focus:text-indigo-700 focus:outline-none mb-4">
                <div className="flex items-center">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
              ...
              <li className="pl-6 cursor-pointer text-gray-600 text-sm leading-3 tracking-normal py-2 hover:text-indigo-700 focus:text-indigo-700 focus:outline-none">
                <div className="flex items-center">
                  ...
                  <Link to="resume" className="ml-2">Resume</Link>
                </div>
              </li>
            </ul>
          </div>
                  ...
                  <ul aria-orientation="vertical" className=" py-6">
                    <li className="pl-6 cursor-pointer text-white text-sm leading-3 tracking-normal pb-4 pt-5 text-indigo-700 focus:text-indigo-700 focus:outline-none">
                      <div className="flex items-center">
                        ...
                        <span className="ml-2 xl:text-base text-black md:text-2xl text-base">
                          Dashboard
                        </span>
                      </div>
                    </li>
                          ...
                          <ul className="p-2 w-full border-r bg-white absolute rounded left-0 shadow mt-12 sm:mt-16 ">
                            <li className="flex w-full justify-between text-gray-600 hover:text-indigo-700 cursor-pointer items-center">
                              <div className="flex items-center">
                                ...
                                <Link to="/profile" className="text-sm ml-2">My Profile</Link>
                              </div>
                            </li>
                            <li className="flex w-full justify-between text-gray-600 hover:text-indigo-700 cursor-pointer items-center mt-2">
                              <div className="flex items-center">
                                ...
                                <span onClick={logout} className="text-sm ml-2">Sign out</span>
                              </div>
                            </li>
                          </ul>
                        ) : (
