...
const CompanyDetails = () => {
    ...
    return (
        <div className="text-white md:flex items-start justify-center py-12 2xl:px-20 md:px-6 px-4 ">
            ...
            <div className="xl:w-2/5 md:w-1/2 lg:ml-8 md:ml-6 md:mt-0 mt-6">
                <div className="border-b border-gray-200 pb-6">
                    <p className="text-sm leading-none text-white">Balenciaga Fall Collection</p>
                    <h1
                        className="
							lg:text-2xl
							text-xl
